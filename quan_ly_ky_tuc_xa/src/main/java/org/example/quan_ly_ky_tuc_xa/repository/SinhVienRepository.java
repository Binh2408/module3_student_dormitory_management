    ...
    public List<SinhVienDtoResponse> findAll() {
        ...
        try (Connection connection = BaseRepository.getConnectDB();
            ...
            while (resultSet.next()) {
                ...
                org.example.quan_ly_ky_tuc_xa.dto.SinhVienDtoResponse sinhVienDtoResponse = new org.example.quan_ly_ky_tuc_xa.dto.SinhVienDtoResponse(sinhVienId,tenSinhVien, userName);
