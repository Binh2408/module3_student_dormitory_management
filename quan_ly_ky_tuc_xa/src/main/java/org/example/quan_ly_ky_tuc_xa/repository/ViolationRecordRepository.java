...
public class ViolationRecordRepository implements IViolationRecordRepository{
    ...
    static {
        ...
        violationRecords.add(new ViolationRecord("003", "Nguyen Van A",
                "Xả rác", "Trung bình", LocalDate.parse("10/05/2024", formatter)));
        violationRecords.add(new ViolationRecord("005", "Tran Thi B",
                "Hút thuốc trong phòng", "Nghiêm trọng", LocalDate.parse("15/05/2024", formatter)));
        violationRecords.add(new ViolationRecord("002", "Le Van C",
    ...
    public void add(ViolationRecord violationRecord) {
        violationRecords.add(violationRecord);
    }
}
