  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        <li class="nav-item">
          <button class="btn btn-outline-success m-1" onclick="showSection('sinhvien-section')">Quản lý sinh
            viên
          </button>
        </li>
        <li class="nav-item">
          <button class="btn btn-outline-success m-1" onclick="showSection('contract-section')">Quản lý hợp
            đồng
          </button>
        </li>
        <li class="nav-item">
          <button class="btn btn-outline-success m-1" onclick="showSection('violation-section')">Quản lý vi
            phạm
          </button>
        </li>
        <li class="nav-item">
          <button class="btn btn-outline-success m-1" onclick="showSection('thongKe')">Thống kê doanh thu
          </button>
        </li>
      </ul>
    </div>
...
<!-- QUẢN LÝ SINH VIÊN -->
<div class="container container-section" id="sinhvien-section" style="display: none">
  <h2 class="text-center text-info mt-4">Student Management (Coming Soon)</h2>
</div>

<!-- QUẢN LÝ HỢP ĐỒNG -->
<div class="container container-section" id="contract-section" style="display: none">
  <h2 class="text-center mt-3 mb-4 text-primary">CONTRACT MANAGEMENT</h2>
...
<div class="modal fade" id="violationDetailModal" tabindex="-1">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title">Violation Detail</h5>
        <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
      </div>
      <div class="modal-body">
        <p>Sinh viên Le Van A đã vi phạm 3 lần quy định ký túc xá. Vui lòng liên hệ ban quản lý để biết thêm chi
          tiết.</p>
      </div>
    </div>
  </div>
